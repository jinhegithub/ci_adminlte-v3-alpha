...
<body class="hold-transition sidebar-mini">
	...
	<!-- ChartJS 1.0.2 -->
	<script src="<?php echo base_url('assets');?>/vendor/AdminLTE-3.0.0-alpha/plugins/chart.js/Chart.min.js"></script>
	<!-- PAGE SCRIPTS -->
	<script src="<?php echo base_url('assets');?>/vendor/AdminLTE-3.0.0-alpha/dist/js/pages/dashboard3.js"></script>
</body>
</html>
